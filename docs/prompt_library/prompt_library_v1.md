...
## Version History
- v1.2.57 (2026-03-10, Jira SCRUM-276): Record end_prompt evidence for installer invitation signup mode with companyName claims and relaxed position validation.
