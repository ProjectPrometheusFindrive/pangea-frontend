...
## Version History
- v1.2.67 (2026-03-10, Jira SCRUM-287): Record end_prompt evidence for scheduled-task selection UX and in-progress status patching on installer device installations.
