...
## Version History
- v1.2.61 (2026-03-10, Jira SCRUM-280): Record end_prompt evidence for ActionRequired pageSize/filter param alignment and FE regression coverage for filter UI contracts.
