...
- Tags: prompt-library,workflow,branch-policy,history-policy,commit-policy,pr-automation,jira-traceability,end-prompt-protocol,worktree-cleanup,jira-status-sync,jira-comment-sync,ac-evidence,mock-removal,reservations-write,ocr-flow
...
## Version History
- v1.2.25 (2026-02-26, SCRUM-64): Add prompt_history evidence rule for BK-085 OCR flow integration (upload/sign + extract/job polling + partial/reupload/fallback/error branches).
