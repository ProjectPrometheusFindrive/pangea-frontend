...
## Version History
- v1.2.60 (2026-03-10, Jira SCRUM-279): Record end_prompt evidence for installer status-transition button fixes, including complete-handler ids and action-specific error paths.
