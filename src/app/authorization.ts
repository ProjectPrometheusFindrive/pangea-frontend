...
export const ACTION_PERMISSIONS = {
  ...
  billingChargesWrite: 'action.billing.charges.write',
  paymentsCreate: 'action.payments.create',
  paymentsConfirm: 'action.payments.confirm',
  paymentsAllocate: 'action.payments.allocate',
  paymentsVoid: 'action.payments.void',
  paymentsRefund: 'action.payments.refund',
  billingWaive: 'action.billing.waive',
  accidentClaimsDraft: 'action.accident-claims.draft',
  accidentClaimsSubmit: 'action.accident-claims.submit',
  accidentClaimsRecognize: 'action.accident-claims.recognize',
  reservationsTransition: 'action.reservations.transition',
...
export const KNOWN_APP_PERMISSIONS: AppPermission[] = [
  ...
  ACTION_PERMISSIONS.billingChargesWrite,
  ACTION_PERMISSIONS.paymentsCreate,
  ACTION_PERMISSIONS.paymentsConfirm,
  ACTION_PERMISSIONS.paymentsAllocate,
  ACTION_PERMISSIONS.paymentsVoid,
  ACTION_PERMISSIONS.paymentsRefund,
  ACTION_PERMISSIONS.billingWaive,
  ACTION_PERMISSIONS.accidentClaimsDraft,
  ACTION_PERMISSIONS.accidentClaimsSubmit,
  ACTION_PERMISSIONS.accidentClaimsRecognize,
  ACTION_PERMISSIONS.reservationsTransition,
